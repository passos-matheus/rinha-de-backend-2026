...
- [ ] O modo de rede configurado está como **bridge**.
- [ ] Meu load-balancer passou na lei Gabriel-2025 (load-balancers não podem ter lógica de aplicação nem responder pela suas API's).
